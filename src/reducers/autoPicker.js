import {
    ...
    SAVE_NEW_INSPECTION_REPORT_FAIL,
    SAVE_NEW_INSPECTION_REPORT_SUCCESS,
    SAVE_EDITTED_COMPUTER_ERRORS_REPORT,
    EDIT_INSPECTION_COMPUTER_ERRORS_REPORT,EDIT_PEDANT_PART_DESCRIPTION
...
export default function (state = initialState, action) {
    ...
    switch (type) {
        ...
        case EDIT_INSPECTION_SALON_REPORT,
            ...
            EDIT_INSPECTION_TRANSMISSION_REPORT, EDIT_INSPECTION_COMPUTER_ERRORS_REPORT, EDIT_PEDANT_PART_DESCRIPTION:
            return {
                ...state, report: payload,
            };
