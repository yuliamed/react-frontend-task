...
import { getOrderById } from '../../actions/orders/userSelectionOrders';
import { connect } from "react-redux";
import { useNavigate } from 'react-router-dom';
import { EditOutlined, CloseSquareOutlined,SaveOutlined } from '@ant-design/icons';
...
class WithNavigate extends Component {
    ...
    async componentDidMount() {
        ...
        dispatch(getOrderById(localStorage.getItem("urderId"), window.location.href.split("/").pop())).then((data) => {
